namespace MCSkin3D.Forms
{
	partial class SkinSizeMismatch
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Location = new System.Drawing.Point(324, 155);
			this.button2.Name = "button2";
			this.languageProvider1.SetPropertyNames(this.button2, "Text");
			this.button2.Size = new System.Drawing.Size(75, 23);
			this.button2.TabIndex = 1;
			this.button2.Text = "C_SCALE";
			...
			this.label1.Size = new System.Drawing.Size(387, 143);
			this.label1.TabIndex = 3;
			this.label1.Text = "M_SKINSIZEMISMATCH";
			...
			this.languageProvider1.SetPropertyNames(this.button3, "Text");
			this.button3.Size = new System.Drawing.Size(75, 23);
			this.button3.TabIndex = 4;
			this.button3.Text = "C_CROP";
