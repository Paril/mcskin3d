...
using System.Text;
using MCSkin3D;
using ModelBase = MCSkin3D.ModelLoader.ModelBase;
using ModelRenderer = MCSkin3D.ModelLoader.ModelRenderer;
using PlaneRenderer = MCSkin3D.ModelLoader.PlaneRenderer;
...
namespace MCSkin3D.Models
{
	...
	public class ModelCloak : ModelBase
	{
		...
		public ModelCloak()
		{
			bipedCloak = new ModelRenderer(this, 0, 0, ModelPart.LeftLeg);
	...
	public class ModelVillager : ModelBase
	{
		...
		public ModelVillager(float f, float f1)
		{
			...
			byte byte0 = 64;
			byte byte1 = 64;
			head = (new ModelRenderer(this, ModelPart.Head)).setTextureSize(byte0, byte1);
			...
			arms = (new ModelRenderer(this, ModelPart.LeftArm)).setTextureSize(byte0, byte1);
			...
			field_40336_d = (new ModelRenderer(this, 0, 22, ModelPart.LeftLeg)).setTextureSize(byte0, byte1);
			field_40336_d.setRotationPoint(-2F, 12F + f1, 0.0F);
			field_40336_d.addBox("Left Leg", -2F, 0.0F, -2F, 4, 12, 4, f);
			field_40337_e = (new ModelRenderer(this, 0, 22, ModelPart.RightLeg)).setTextureSize(byte0, byte1);
			...
			body = (new ModelRenderer(this, ModelPart.Chest)).setTextureSize(byte0, byte1);
			body.setRotationPoint(0.0F, 0.0F + f1, 0.0F);
			body.setTextureOffset(16, 20).addBox("Body", -4F, 0.0F, -3F, 8, 12, 6, f);
			bodyOverwear = (new ModelRenderer(this, ModelPart.Chest)).setTextureSize(byte0, byte1);
	...
	public class ModelCreeper : ModelBase
	{
		...
		public ModelCreeper(float f)
		{
			...
			body = new ModelRenderer(this, 16, 16, ModelPart.Chest);
	...
	public class ModelCow : ModelQuadruped
	{
			...
			base(12, 0)
		{
			...
			boxList.Remove(body);
			body = new ModelRenderer(this, 18, 4, ModelPart.Chest);
	...
	public class ModelSlime : ModelBase
	{
		...
		{
			slimeBodies = new ModelRenderer(this, 0, 0, ModelPart.Head);
			slimeBodies.addBox("Slime", -4F, 16F, -4F, 8, 8, 8);
			if (i > 0)
			{
				slimeBodies2 = new ModelRenderer(this, 0, i, ModelPart.Helmet);
				slimeBodies2.addBox("Slime", -3F, 17F, -3F, 6, 6, 6);
				slimeRightEye = new ModelRenderer(this, 32, 0, ModelPart.RightLeg);
				slimeRightEye.addBox("Eye", -3.25F, 18F, -3.5F, 2, 2, 2);
				slimeLeftEye = new ModelRenderer(this, 32, 4, ModelPart.LeftLeg);
				slimeLeftEye.addBox("Eye", 1.25F, 18F, -3.5F, 2, 2, 2);
				slimeMouth = new ModelRenderer(this, 32, 8, ModelPart.Chest);
	...
	public class ModelSquid : ModelBase
	{
		...
		public ModelSquid()
		{
			...
			var byte0 = -16;
			squidBody = new ModelRenderer(this, 0, 0, ModelPart.Chest);
			squidBody.addBox("Body", -6F, -8F, -6F, 12, 16, 12);
			squidBody.rotationPointY += 24 + byte0;
			for (int i = 0; i < squidTentacles.Length; i++)
			{
				squidTentacles[i] = new ModelRenderer(this, 48, 0, ModelPart.LeftArm);
	...
	public class ModelMagmaCube : ModelBase
	{
		...
		public ModelMagmaCube()
		{
			...
			for (int i = 0; i < field_40345_a.Length; i++)
			{
				...
				field_40345_a[i] = new ModelRenderer(this, byte0, j, ModelPart.Head);
				field_40345_a[i].addBox("Head", -4F, 16 + i, -4F, 8, 1, 8);
			}

			field_40344_b = new ModelRenderer(this, 0, 16, ModelPart.Chest);
	...
	public class ModelBlaze : ModelBase
	{
		...
		public ModelBlaze()
		{
			...
			{
				field_40323_a[i] = new ModelRenderer(this, 0, 16, ModelPart.LeftArm);
				field_40323_a[i].addBox("Rod", 0.0F, 0.0F, 0.0F, 2, 8, 2);
			}

			field_40322_b = new ModelRenderer(this, 0, 0, ModelPart.Head);
	...
	public class ModelSilverfish : ModelBase
	{
		...
		public ModelSilverfish()
		{
			...
			{
				silverfishBodyParts[i] = new ModelRenderer(this, silverfishTexturePositions[i, 0], silverfishTexturePositions[i, 1], ModelPart.Chest);
			...
			silverfishWings[0] = new ModelRenderer(this, 20, 0, ModelPart.Head);
			...
			silverfishWings[1] = new ModelRenderer(this, 20, 11, ModelPart.Head);
			...
			silverfishWings[2] = new ModelRenderer(this, 20, 18, ModelPart.Head);
	...
	public class ModelEnderman : ModelBiped
	{
			...
			base(0.0F, -14F)
		{
			...
			bipedLeftLeg = new ModelRenderer(this, 56, 0, ModelPart.LeftLeg);
			bipedLeftLeg.mirror = true;
	...
	public class ModelGhast : ModelBase
	{
		...
		public ModelGhast()
		{
			...
			int byte0 = -16;
			body = new ModelRenderer(this, 0, 0, ModelPart.Chest);
			body.addBox("Body", -8F, -8F, -8F, 16, 16, 16);
			body.rotationPointY += 24 + byte0;
			Random random = new Random(1660);
			for (int i = 0; i < tentacles.Length; i++)
			{
				tentacles[i] = new ModelRenderer(this, 0, 0, ModelPart.LeftLeg);
	...
	public class ModelChest : ModelBase
	{
		...
		public ModelChest()
		{
			chestLid = (new ModelRenderer(this, 0, 0, ModelPart.Head)).setTextureSize(64, 64);
			...
			chestKnob = (new ModelRenderer(this, 0, 0, ModelPart.Helmet)).setTextureSize(64, 64);
			...
			chestBelow = (new ModelRenderer(this, 0, 19, ModelPart.Chest)).setTextureSize(64, 64);
	...
	public class ModelLargeChest : ModelBase
	{
		...
		{
			chestLid = (new ModelRenderer(this, 0, 0, ModelPart.Head)).setTextureSize(128, 64);
			chestLid.addBox("Lid", 0.0F, -5F, -14F, 30, 5, 14, 0.0F);
			chestLid.rotationPointX = 1.0F;
			chestLid.rotationPointY = 7F;
			chestLid.rotationPointZ = 15F;
			chestKnob = (new ModelRenderer(this, 0, 0, ModelPart.Helmet)).setTextureSize(128, 64);
			chestKnob.addBox("Knob", -1F, -2F, -15F, 2, 4, 1, 0.0F);
			chestKnob.rotationPointX = 16F;
			chestKnob.rotationPointY = 7F;
			chestKnob.rotationPointZ = 15F;
			chestBelow = (new ModelRenderer(this, 0, 19, ModelPart.Chest)).setTextureSize(128, 64);
	...
	public class ModelBoat : ModelBase
	{
		...
		public ModelBoat()
		{
			...
			boatSides[0] = new ModelRenderer(this, 0, 8, ModelPart.Head);
			boatSides[1] = new ModelRenderer(this, 0, 0, ModelPart.Helmet);
			boatSides[2] = new ModelRenderer(this, 0, 0, ModelPart.Chest);
			boatSides[3] = new ModelRenderer(this, 0, 0, ModelPart.LeftArm);
			boatSides[4] = new ModelRenderer(this, 0, 0, ModelPart.RightArm);
			byte byte0 = 24;
			byte byte1 = 6;
			byte byte2 = 20;
			byte byte3 = 4;
	...
	public class SignModel : ModelBase
	{
		...
		public SignModel()
		{
			signBoard = new ModelRenderer(this, 0, 0, ModelPart.Helmet);
			signBoard.addBox("Board", -12F, -14F, -1F, 24, 12, 2, 0.0F);
			signStick = new ModelRenderer(this, 0, 14, ModelPart.Chest);
	...
	public class ModelBook : ModelBase
	{
		...
		public ModelBook()
		{
			field_40330_a = (new ModelRenderer(this, ModelPart.Head)).setTextureOffset(0, 0).addBox("Left Cover", -6F, -5F, 0.0F, 6, 10, 0);
			field_40328_b = (new ModelRenderer(this, ModelPart.Chest)).setTextureOffset(16, 0).addBox("Right Cover", 0.0F, -5F, 0.0F, 6, 10, 0);
			field_40325_g = (new ModelRenderer(this, ModelPart.Helmet)).setTextureOffset(12, 0).addBox("Spine", -1F, -5F, 0.0F, 2, 10, 0);
			field_40329_c = (new ModelRenderer(this, ModelPart.LeftArm)).setTextureOffset(0, 10).addBox("Page", 0.0F, -4F, -0.99F, 5, 8, 1);
			field_40326_d = (new ModelRenderer(this, ModelPart.LeftLeg)).setTextureOffset(12, 10).addBox("Page", 0.0F, -4F, -0.01F, 5, 8, 1);
			field_40327_e = (new ModelRenderer(this, ModelPart.RightArm)).setTextureOffset(24, 10).addBox("Page", 0.0F, -4F, 0.0F, 5, 8, 0);
			field_40324_f = (new ModelRenderer(this, ModelPart.RightLeg)).setTextureOffset(24, 10).addBox("Page", 0.0F, -4F, 0.0F, 5, 8, 0);
	...
	public class ModelMinecart : ModelBase
	{
		...
		public ModelMinecart()
		{
			...
			sideModels[0] = new ModelRenderer(this, 0, 10, ModelPart.Head);
			sideModels[1] = new ModelRenderer(this, 0, 0, ModelPart.LeftArm);
			sideModels[2] = new ModelRenderer(this, 0, 0, ModelPart.LeftLeg);
			sideModels[3] = new ModelRenderer(this, 0, 0, ModelPart.RightArm);
			sideModels[4] = new ModelRenderer(this, 0, 0, ModelPart.RightLeg);
			sideModels[5] = new ModelRenderer(this, 44, 10, ModelPart.Chest);
			byte byte0 = 20;
			byte byte1 = 8;
			byte byte2 = 16;
			byte byte3 = 4;
	...
	public class ModelEnderCrystal : ModelBase
	{
		...
		{
			field_41058_h = new ModelRenderer(this, "glass", ModelPart.Head);
			field_41058_h.setTextureOffset(0, 0).addBox("Glass", -4F, -4F, -4F, 8, 8, 8);
			field_41057_g = new ModelRenderer(this, "cube", ModelPart.Helmet);
			field_41057_g.setTextureOffset(32, 0).addBox("Cube", -4F, -4F, -4F, 8, 8, 8);
			field_41059_i = new ModelRenderer(this, "base", ModelPart.Chest);
	...
	public class pm_Pony : ModelBase
	{
		...
		public void init(float yoffset, float init_strech)
		{
			...
			this.headpiece[0] = new ModelRenderer(this, 12, 16, ModelPart.Helmet);
			...
			this.headpiece[1] = new ModelRenderer(this, 12, 16, ModelPart.Helmet);
			...
			this.headpiece[2] = new ModelRenderer(this, 56, 0, ModelPart.Helmet);
			...
			this.helmet = new ModelRenderer(this, 32, 0, ModelPart.Helmet);
			...
			this.Bodypiece[0] = new PlaneRenderer(this, "Body.Body", 24, 0, ModelPart.RightLeg);
			...
			this.Bodypiece[1] = new PlaneRenderer(this, "Body.Body", 24, 0, ModelPart.RightLeg);
			...
			this.Bodypiece[2] = new PlaneRenderer(this, "Body.Body", 24, 0, ModelPart.Chest);
			...
			this.Bodypiece[3] = new PlaneRenderer(this, "Body.Body", 24, 0, ModelPart.Chest);
			...
			this.Bodypiece[4] = new PlaneRenderer(this, "Body.Cutie Mark", 0, 20, ModelPart.Head);
			...
			this.Bodypiece[5] = new PlaneRenderer(this, "Body.Body", 0, 20, ModelPart.Head);
			...
			this.Bodypiece[6] = new PlaneRenderer(this, "Body.Body", 24, 0, ModelPart.Chest);
			...
			this.Bodypiece[7] = new PlaneRenderer(this, "Body.Body", 24, 0, ModelPart.Chest);
			...
			this.Bodypiece[8] = new PlaneRenderer(this, "Body.Body", 24, 0, ModelPart.Chest);
			...
			this.Bodypiece[9] = new PlaneRenderer(this, "Body.Body", 32, 0, ModelPart.Chest);
			...
			this.Bodypiece[10] = new PlaneRenderer(this, "Body.Body", 32, 0, ModelPart.Chest);
			...
			this.Bodypiece[11] = new PlaneRenderer(this, "Body.Body", 32, 0, ModelPart.Head);
			...
			this.Bodypiece[12] = new PlaneRenderer(this, "Body.Body", 32, 0, ModelPart.Head);
			...
			this.unicornarm = new ModelRenderer(this, 40, 16, ModelPart.Head);
			...
			this.Tail[0] = new PlaneRenderer(this, "Tail.Tail", 32, 0, ModelPart.Chest);
			...
			this.Tail[1] = new PlaneRenderer(this, "Tail.Tail", 32, 0, ModelPart.Chest);
			...
			this.Tail[2] = new PlaneRenderer(this, "Tail.Tail", 32, 0, ModelPart.Chest);
			...
			this.Tail[3] = new PlaneRenderer(this, "Tail.Tail", 32, 0, ModelPart.Chest);
			...
			this.Tail[4] = new PlaneRenderer(this, "Tail.Tail", 32, 0, ModelPart.Chest);
			...
			this.Tail[5] = new PlaneRenderer(this, "Tail.Tail", 32, 0, ModelPart.Chest);
			...
			this.Tail[6] = new PlaneRenderer(this, "Tail.Tail", 36, 0, ModelPart.Chest);
			...
			this.Tail[7] = new PlaneRenderer(this, "Tail.Tail", 36, 0, ModelPart.Chest);
			...
			this.Tail[8] = new PlaneRenderer(this, "Tail.Tail", 36, 0, ModelPart.Chest);
			...
			this.Tail[9] = new PlaneRenderer(this, "Tail.Tail", 36, 0, ModelPart.Chest);
			...
			this.LeftWing[0] = new ModelRenderer(this, 56, 16, ModelPart.RightLeg);
			this.LeftWing[0].mirror = true;
			this.LeftWing[0].addBox("Wings.Folded.Left Wing.Left Wing", 4.0F, 5.0F, 2.0F, 2, 6, 2, this.strech);
			this.LeftWing[0].setRotationPoint(WingR1, WingR2 + yoffset, WingR3);

			this.LeftWing[1] = new ModelRenderer(this, 56, 16, ModelPart.RightLeg);
			this.LeftWing[1].mirror = true;
			this.LeftWing[1].addBox("Wings.Folded.Left Wing.Left Wing", 4.0F, 5.0F, 4.0F, 2, 8, 2, this.strech);
			this.LeftWing[1].setRotationPoint(WingR1, WingR2 + yoffset, WingR3);

			this.LeftWing[2] = new ModelRenderer(this, 56, 16, ModelPart.RightLeg);
			this.LeftWing[2].mirror = true;
			this.LeftWing[2].addBox("Wings.Folded.Left Wing.Left Wing", 4.0F, 5.0F, 6.0F, 2, 6, 2, this.strech);
			this.LeftWing[2].setRotationPoint(WingR1, WingR2 + yoffset, WingR3);

			this.RightWing = new ModelRenderer[3];

			this.RightWing[0] = new ModelRenderer(this, 56, 16, ModelPart.RightLeg);
			this.RightWing[0].addBox("Wings.Folded.Right Wing.Right Wing", -6.0F, 5.0F, 2.0F, 2, 6, 2, this.strech);
			this.RightWing[0].setRotationPoint(WingR1, WingR2 + yoffset, WingR3);

			this.RightWing[1] = new ModelRenderer(this, 56, 16, ModelPart.RightLeg);
			this.RightWing[1].addBox("Wings.Folded.Right Wing.Right Wing", -6.0F, 5.0F, 4.0F, 2, 8, 2, this.strech);
			this.RightWing[1].setRotationPoint(WingR1, WingR2 + yoffset, WingR3);

			this.RightWing[2] = new ModelRenderer(this, 56, 16, ModelPart.RightLeg);
			this.RightWing[2].addBox("Wings.Folded.Right Wing.Right Wing", -6.0F, 5.0F, 6.0F, 2, 6, 2, this.strech);
			...
			this.LeftWingExt[0] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.LeftWingExt[0].mirror = true;

			this.LeftWingExt[0].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 0.0F, 0.0F, 1, 8, 2, this.strech + 0.1F);
			this.LeftWingExt[0].setRotationPoint(LeftWingExtR1, LeftWingExtR2 + yoffset, LeftWingExtR3);

			this.LeftWingExt[1] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.LeftWingExt[1].mirror = true;

			this.LeftWingExt[1].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 8.0F, 0.0F, 1, 6, 2, this.strech + 0.1F);
			this.LeftWingExt[1].setRotationPoint(LeftWingExtR1, LeftWingExtR2 + yoffset, LeftWingExtR3);

			this.LeftWingExt[2] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.LeftWingExt[2].mirror = true;
			this.LeftWingExt[2].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, -1.2F, -0.2F, 1, 8, 2, this.strech - 0.2F);
			this.LeftWingExt[2].setRotationPoint(LeftWingExtR1, LeftWingExtR2 + yoffset, LeftWingExtR3);

			this.LeftWingExt[3] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.LeftWingExt[3].mirror = true;
			this.LeftWingExt[3].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 1.8F, 1.3F, 1, 8, 2, this.strech - 0.1F);
			this.LeftWingExt[3].setRotationPoint(LeftWingExtR1, LeftWingExtR2 + yoffset, LeftWingExtR3);

			this.LeftWingExt[4] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.LeftWingExt[4].mirror = true;
			this.LeftWingExt[4].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 5.0F, 2.0F, 1, 8, 2, this.strech);
			this.LeftWingExt[4].setRotationPoint(LeftWingExtR1, LeftWingExtR2 + yoffset, LeftWingExtR3);

			this.LeftWingExt[5] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.LeftWingExt[5].mirror = true;

			this.LeftWingExt[5].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 0.0F, -0.2F, 1, 6, 2, this.strech + 0.3F);
			this.LeftWingExt[5].setRotationPoint(LeftWingExtR1, LeftWingExtR2 + yoffset, LeftWingExtR3);

			this.LeftWingExt[6] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.LeftWingExt[6].mirror = true;

			this.LeftWingExt[6].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 0.0F, 0.2F, 1, 3, 2, this.strech + 0.2F);
			...
			this.RightWingExt[0] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.RightWingExt[0].mirror = true;

			this.RightWingExt[0].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F, 0.0F, 0.0F, 1, 8, 2, this.strech + 0.1F);
			this.RightWingExt[0].setRotationPoint(RightWingExtR1, RightWingExtR2 + yoffset, RightWingExtR3);

			this.RightWingExt[1] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.RightWingExt[1].mirror = true;

			this.RightWingExt[1].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F, 8.0F, 0.0F, 1, 6, 2, this.strech + 0.1F);
			this.RightWingExt[1].setRotationPoint(RightWingExtR1, RightWingExtR2 + yoffset, RightWingExtR3);

			this.RightWingExt[2] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.RightWingExt[2].mirror = true;
			this.RightWingExt[2].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F, -1.2F, -0.2F, 1, 8, 2, this.strech - 0.2F);
			this.RightWingExt[2].setRotationPoint(RightWingExtR1, RightWingExtR2 + yoffset, RightWingExtR3);

			this.RightWingExt[3] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.RightWingExt[3].mirror = true;
			this.RightWingExt[3].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F, 1.8F, 1.3F, 1, 8, 2, this.strech - 0.1F);
			this.RightWingExt[3].setRotationPoint(RightWingExtR1, RightWingExtR2 + yoffset, RightWingExtR3);

			this.RightWingExt[4] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.RightWingExt[4].mirror = true;
			this.RightWingExt[4].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F, 5.0F, 2.0F, 1, 8, 2, this.strech);
			this.RightWingExt[4].setRotationPoint(RightWingExtR1, RightWingExtR2 + yoffset, RightWingExtR3);

			this.RightWingExt[5] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.RightWingExt[5].mirror = true;

			this.RightWingExt[5].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F, 0.0F, -0.2F, 1, 6, 2, this.strech + 0.3F);
			this.RightWingExt[5].setRotationPoint(RightWingExtR1, RightWingExtR2 + yoffset, RightWingExtR3);

			this.RightWingExt[6] = new ModelRenderer(this, 56, 19, ModelPart.RightLeg);
			this.RightWingExt[6].mirror = true;

			this.RightWingExt[6].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F, 0.0F, 0.2F, 1, 3, 2, this.strech + 0.2F);
	...
	public class pm_newPonyAdv : ModelBase
	{
		...
		public pm_newPonyAdv init(float f, float f1)
		{
			...
			MuzzleFemale[0] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 10, 14, ModelPart.Head);
			MuzzleFemale[0].addBackPlane(-2F, 1.0F, -7F, 4, 2, 0, strech);
			MuzzleFemale[0].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[1] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 11, 13, ModelPart.Head);
			MuzzleFemale[1].addBackPlane(-1F, 0F, -7F, 2, 1, 0, strech);
			MuzzleFemale[1].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[2] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 9, 14, ModelPart.Head);
			MuzzleFemale[2].addTopPlane(-2F, 1.0F, -7F, 1, 0, 1, strech);
			MuzzleFemale[2].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[3] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 14, 14, ModelPart.Head);
			MuzzleFemale[3].addTopPlane(1.0F, 1.0F, -7F, 1, 0, 1, strech);
			MuzzleFemale[3].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[4] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 11, 12, ModelPart.Head);
			MuzzleFemale[4].addTopPlane(-1F, 0F, -7F, 2, 0, 1, strech);
			MuzzleFemale[4].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[5] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 18, 7, ModelPart.Head);
			MuzzleFemale[5].addTopPlane(-2F, 3F, -7F, 4, 0, 1, strech);
			MuzzleFemale[5].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[6] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 9, 14, ModelPart.Head);
			MuzzleFemale[6].addSidePlane(-2F, 1.0F, -7F, 0, 2, 1, strech);
			MuzzleFemale[6].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[7] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 14, 14, ModelPart.Head);
			MuzzleFemale[7].addSidePlane(2.0F, 1.0F, -7F, 0, 2, 1, strech);
			MuzzleFemale[7].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[8] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 11, 12, ModelPart.Head);
			MuzzleFemale[8].addSidePlane(-1F, 0F, -7F, 0, 1, 1, strech);
			MuzzleFemale[8].setRotationPoint(f2, f3 + f, f4);
			MuzzleFemale[9] = new PlaneRenderer(this, "Muzzles.Female.Female Muzzle", 12, 12, ModelPart.Head);
			...
			LeftWing[0] = new ModelRenderer(this, 56, 16, ModelPart.Head);
			...
			LeftWing[1] = new ModelRenderer(this, 56, 16, ModelPart.Head);
			...
			LeftWing[2] = new ModelRenderer(this, 56, 16, ModelPart.Head);
			...
			LeftWingExt[0] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			LeftWingExt[0].mirror = true;
			LeftWingExt[0].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 0.0F, 0.0F, 1, 8, 2, strech + 0.1F);
			LeftWingExt[0].setRotationPoint(f17, f18 + f, f19);
			LeftWingExt[1] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			...
			LeftWingExt[2] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			LeftWingExt[2].mirror = true;
			LeftWingExt[2].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, -1.2F, -0.2F, 1, 8, 2, strech - 0.2F);
			LeftWingExt[2].setRotationPoint(f17, f18 + f, f19);
			LeftWingExt[3] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			LeftWingExt[3].mirror = true;
			LeftWingExt[3].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 1.8F, 1.3F, 1, 8, 2, strech - 0.1F);
			LeftWingExt[3].setRotationPoint(f17, f18 + f, f19);
			LeftWingExt[4] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			...
			LeftWingExt[5] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			LeftWingExt[5].mirror = true;
			LeftWingExt[5].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 0.0F, -0.2F, 1, 6, 2, strech + 0.3F);
			LeftWingExt[5].setRotationPoint(f17, f18 + f, f19);
			LeftWingExt[6] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			LeftWingExt[6].mirror = true;
			LeftWingExt[6].addBox("Wings.Extended.Left Wing Extended.Left Wing Extended", 0.0F, 0.0F, 0.2F, 1, 3, 2, strech + 0.2F);
			LeftWingExt[6].setRotationPoint(f17, f18 + f, f19);
			float f20 = f2 - 4.5F;
			float f21 = f3 + 5F;
			float f22 = f4 + 6F;
			RightWingExt = new ModelRenderer[7];
			RightWingExt[0] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			RightWingExt[0].mirror = true;
			RightWingExt[0].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F - 1, 0.0F, 0.0F, 1, 8, 2, strech + 0.1F);
			RightWingExt[0].setRotationPoint(f20, f21 + f, f22);
			RightWingExt[1] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			RightWingExt[1].mirror = true;
			RightWingExt[1].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F - 1, 8F, 0.0F, 1, 6, 2, strech + 0.1F);
			RightWingExt[1].setRotationPoint(f20, f21 + f, f22);
			RightWingExt[2] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			RightWingExt[2].mirror = true;
			RightWingExt[2].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F - 1, -1.2F, -0.2F, 1, 8, 2, strech - 0.2F);
			RightWingExt[2].setRotationPoint(f20, f21 + f, f22);
			RightWingExt[3] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			RightWingExt[3].mirror = true;
			RightWingExt[3].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F - 1, 1.8F, 1.3F, 1, 8, 2, strech - 0.1F);
			RightWingExt[3].setRotationPoint(f20, f21 + f, f22);
			RightWingExt[4] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			...
			RightWingExt[5] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			RightWingExt[5].mirror = true;
			RightWingExt[5].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F - 1, 0.0F, -0.2F, 1, 6, 2, strech + 0.3F);
			RightWingExt[5].setRotationPoint(f20, f21 + f, f22);
			RightWingExt[6] = new ModelRenderer(this, 56, 19, ModelPart.Head);
			RightWingExt[6].mirror = true;
			RightWingExt[6].addBox("Wings.Extended.Right Wing Extended.Right Wing Extended", 0.0F - 1, 0.0F, 0.2F, 1, 3, 2, strech + 0.2F);
	...
	public class ModelOzelot : ModelBase
	{
		...
		{
			o = 0;
			g = new ModelRenderer(this, "head", ModelPart.Head);
	...
	public class ModelGolem : ModelBase
	{
		...
		public ModelGolem(float f1, float f2)
		{
			byte byte0 = 96;
			byte byte1 = 96;
			a = (new ModelRenderer(this, ModelPart.Chest)).setTextureSize(byte0, byte1);
			...
			b = (new ModelRenderer(this, ModelPart.Chest)).setTextureSize(byte0, byte1);
