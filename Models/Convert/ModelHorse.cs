...
{
	public class ModelHorse : ModelBase
	{
		...
		public ModelHorse()
		{
			...
			this.body.addBox(-5.0F, -8.0F, -19.0F, 10, 10, 24, "Chest");
			this.body.setRotationPoint(0.0F, 11.0F, 9.0F);
			this.tailBase = new ModelRenderer(this, 44, 0);
			this.tailBase.addBox(-1.0F, -1.0F, 0.0F, 2, 2, 3, "Tail Base");
			...
			this.tailMiddle.addBox(-1.5F, -2.0F, 3.0F, 3, 4, 7, "Tail Middle");
			...
			this.tailTip.addBox(-1.5F, -4.5F, 9.0F, 3, 4, 7, "Tail Tip");
			...
			this.field_178711_b.addBox(-2.0F, -10.0F, -7.0F, 4, 3, 6, "Mouth Top");
			...
			this.field_178712_c.addBox(-2.0F, -7.0F, -6.5F, 4, 2, 5, "Mouth Bottom");
			...
			this.horseLeftEar.addBox(0.45F, -12.0F, 4.0F, 2, 3, 1, "Left Ear");
			...
			this.horseRightEar.addBox(-2.45F, -12.0F, 4.0F, 2, 3, 1, "Right Ear");
			...
			this.muleLeftEar.addBox(-2.0F, -16.0F, 4.0F, 2, 7, 1, "Left Ear (Mule)");
			...
			this.muleRightEar.addBox(0.0F, -16.0F, 4.0F, 2, 7, 1, "Right Ear (Mule)");
			...
			this.neck.addBox(-2.05F, -9.8F, -2.0F, 4, 14, 8, "Neck");
			...
			this.muleLeftChest.addBox(-3.0F, 0.0F, 0.0F, 8, 8, 3, "Chest Left (Mule)");
			...
			this.muleRightChest.addBox(-3.0F, 0.0F, 0.0F, 8, 8, 3, "Chest Right (Mule)");
			...
			this.horseRightFaceMetal.addBox(-2.5F, -8.0F, -4.0F, 1, 2, 2, "Right Face Metal");
			...
			this.horseLeftRein.addBox(2.6F, -6.0F, -6.0F, 0, 3, 16, "Left Rein");
			this.horseLeftRein.setRotationPoint(0.0F, 4.0F, -10.0F);
			this.horseRightRein = new ModelRenderer(this, 44, 5);
			this.horseRightRein.addBox(-2.6F, -6.0F, -6.0F, 0, 3, 16, "Right Rein");
			this.horseRightRein.setRotationPoint(0.0F, 4.0F, -10.0F);
			this.mane = new ModelRenderer(this, 58, 0);
			this.mane.addBox(-1.0F, -11.5F, 5.0F, 2, 16, 4, "Mane");
			...
			this.horseFaceRopes.addBox(-2.5F, -10.1F, -7.0F, 5, 5, 12, 0.2F, "Face Ropes");
