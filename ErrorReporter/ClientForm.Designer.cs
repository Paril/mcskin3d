namespace ClientTest
{
	partial class ClientForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label7.Text = "If you can provide extra information, such as steps to reproduce, enter it below:" +
    "";
			// 
			// label5
			// 
			...
			this.label6.Text = "Send Hardware Info?:";
			// 
			// label1
			// 
			...
			this.label2.Text = "To view the data that will be sent, click";
			// 
			// pictureBox2
			// 
