...
namespace BrightIdeasSoftware
{
    ...
    public class HeaderControl : NativeWindow
    {
        ...
        protected Rectangle DrawFilterIndicator(Graphics g, Rectangle r) {
            ...
            Image indicator = BrightIdeasSoftware.ObjectListViewResources.filter_icons3;
            int x = r.Right - width;
        ...
        private int CalculateFilterIndicatorWidth(Rectangle r) {
			if (BrightIdeasSoftware.ObjectListViewResources.filter_icons3 == null || r.Width < 48)
                return 0;
			return BrightIdeasSoftware.ObjectListViewResources.filter_icons3.Width + 1;
        }
