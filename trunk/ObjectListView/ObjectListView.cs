...
namespace BrightIdeasSoftware
{
    ...
    public partial class ObjectListView : ListView, ISupportInitialize {
        ...
        /// </summary>
        static public Bitmap SortAscendingImage = BrightIdeasSoftware.ObjectListViewResources.sort_ascending;

        /// <summary>
        /// Gets or sets the image that will be placed next to the Sort Descending command
        /// </summary>
        static public Bitmap SortDescendingImage = BrightIdeasSoftware.ObjectListViewResources.sort_descending;
