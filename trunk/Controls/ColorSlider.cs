...
namespace MB.Controls
{
	...
	{
		private readonly ColorSlider _slider;
	...
	public class DefaultSliderRenderer : SliderRenderer
	{
		public DefaultSliderRenderer(ColorSlider slider) :
			base(slider)
		{
			Slider.OrientationChanged += slider_OrientationChanged;
		}

		private void slider_OrientationChanged(object sender, EventArgs e)
		{
	...
	public partial class ColorSlider : Control
	{
		...
		public SliderRenderer Renderer { get; set; }
