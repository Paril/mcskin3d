...
namespace BrightIdeasSoftware
{
	...
	public class ToolTipControl : NativeWindow
	{
		...
		{
			get { return NativeMethods.GetWindowLong(Handle, GWL_STYLE); }
		...
		{
			get { return (WindowStyle & TTS_BALLOON) == TTS_BALLOON; }
			set
			{
				if (IsBalloon == value)
					return;
		...
		public bool HasBorder
		{
			...
			set
			{
				...
				if (value) WindowStyle |= WS_BORDER;
				else WindowStyle &= ~WS_BORDER;
			}
		}
