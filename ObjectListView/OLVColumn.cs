...
namespace BrightIdeasSoftware
{
	...
	public class OLVColumn : ColumnHeader
	{
		...
		[Category("ObjectListView"), Description("What style will be used to draw the header of this column"),
		 DefaultValue(null)]
		...
		[Category("ObjectListView"), Description("Name of the image that will be shown in the column header."),
		 DefaultValue(null), TypeConverter(typeof (ImageKeyConverter)),
		 Editor(
		 	...
		 	, typeof (UITypeEditor)), RefreshProperties(RefreshProperties.Repaint)]
		...
		/// Gets or sets whether the text values in this column will act like hyperlinks
		/// </summary>
		[Category("ObjectListView"), Description("Will the text values of this column act like hyperlinks?"),
		 DefaultValue(false)]
		...
		[Category("ObjectListView"), Description("Will this column be used when the view is switched to tile view"),
		 DefaultValue(false)]
		...
		/// </summary>
		[Category("ObjectListView"), Description("The renderer will draw this column when the ListView is owner drawn"),
		 DefaultValue(null)]
