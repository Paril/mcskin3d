...
namespace BrightIdeasSoftware
{
	...
	public class TextMatchFilter : AbstractModelFilter
	{
		...
		public IEnumerable<CharacterRange> FindAllMatchedRanges(string cellText)
		{
			...
			foreach (TextMatchingStrategy filter in MatchingStrategies) ranges.AddRange(filter.FindAllMatchedRanges(cellText));
		...
		{
			if (Columns == null) return column.ListView == ListView;
		...
		#region Nested type: TextBeginsMatchingStrategy
		...
		#region Nested type: TextContainsMatchingStrategy
		...
		#region Nested type: TextMatchingStrategy
		...
		#region Nested type: TextRegexMatchingStrategy
